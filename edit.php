                    ...
                    <form action="update.php" method="POST" enctype="multipart/form-data">
                        <div class="row">
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="text" class="form-control" id="roll" name="roll" value="<?php echo $row['roll'] ?>" required readonly>
                            </div>
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="text" class="form-control" id="father" name="father_name" value="<?php echo $row['father'] ?>" required>
                            </div>

                            <!-- Mother's Name -->
                            <div class="col-md-6 mb-3">
                                <label for="mother" class="form-label">Enter Mother's Name</label>
                                <input type="text" class="form-control" id="mother" name="mother_name" value="<?php echo $row['mother'] ?>" required>
                            </div>

                            <!-- Mobile Number -->
                            <div class="col-md-6 mb-3">
                                <label for="mobile" class="form-label">Mobile Number</label>
                                <input type="tel" class="form-control" id="mobile" name="mobile" required value="<?php echo $row['mobile'] ?>">
                            </div>
